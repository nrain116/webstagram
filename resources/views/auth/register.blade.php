...
@section('title', 'Registrieren - WebmasterGram')
...
<div class="container mx-auto max-w-md mt-16 p-6 bg-white shadow-lg rounded-lg">
    ...
    <h2 class="text-2xl font-bold text-center mb-6">Konto erstellen</h2>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-4">
            <label for="username" class="block text-gray-700 mb-1">Benutzername</label>
    ...
    <div class="mt-6 text-center text-gray-500">Oder fortfahren mit</div>

    <div class="mt-4">
        <a href="{{ route('github.login') }}"
           class="w-full flex items-center justify-center gap-2 border px-4 py-2 rounded-lg hover:bg-gray-100">
    ...
    <p class="mt-6 text-center text-gray-500 text-sm">
        Haben Sie bereits ein Konto? <a href="{{ route('login') }}" class="text-blue-500">Anmelden</a>
    </p>
</div>
@endsection
