...
@section('title', 'Sign In - WebmasterGram')
...
<div class="container mx-auto max-w-md mt-16 p-6 bg-white shadow-lg rounded-lg">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-4">
            <label for="login" class="block text-gray-700 mb-1">Username or Email</label>
    ...
    <div class="mt-4 flex justify-center gap-4">
        <a href="{{ route('github.login') }}" class="flex items-center gap-2 border px-4 py-2 rounded-lg hover:bg-gray-100">
